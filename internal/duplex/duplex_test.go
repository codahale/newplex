...
func TestDuplex_Frame(t *testing.T) {
	...
	if got, want := debugDuplex(&d), "1_4_"; got != want {
	...
	if got, want := debugDuplex(&d), "5_8_"; got != want {
		t.Errorf("state = %s, want = %s", got, want)
	}
	...
	if got, want := debugDuplex(&d), "9_12_"; got != want {
		t.Errorf("state = %s, want = %s", got, want)
	}
}
