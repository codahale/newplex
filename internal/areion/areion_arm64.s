...
TEXT ·permute1024Asm(SB), NOSPLIT, $0
	MOVD state+0(FP), R0
	...
	VEOR V16.B16, V16.B16, V16.B16 // zero
	MOVD $·roundConstants1024(SB), R1

#define ROUND1K(s0, s1, s2, s3, s4, s5, s6, s7, off0, off1) \
	/* Branch 0: s1 ^= F0(s0), s0 = F1(s0) */ \
	VORR s0.B16, s0.B16, V8.B16; \
	AESE V16.B16, V8.B16; \
	AESMC V8.B16, V8.B16; \
	VEOR s1.B16, V8.B16, s1.B16; \
	AESE V16.B16, s0.B16; \
	/* Branch 2: s5 ^= F0(s4), s4 = F1(s4) */ \
	VORR s4.B16, s4.B16, V8.B16; \
	AESE V16.B16, V8.B16; \
	AESMC V8.B16, V8.B16; \
	VEOR s5.B16, V8.B16, s5.B16; \
	AESE V16.B16, s4.B16; \
	/* Branch 1: s3 ^= F0(s2), s2 = F3(s2, RC0) */ \
	VORR s2.B16, s2.B16, V8.B16; \
	AESE V16.B16, V8.B16; \
	AESMC V8.B16, V8.B16; \
	VEOR s3.B16, V8.B16, s3.B16; \
	MOVD $off0, R2; \
	ADD R2, R1, R2; \
	VLD1 (R2), [V9.B16]; \
	AESE V16.B16, s2.B16; \
	VEOR V9.B16, s2.B16, s2.B16; \
	AESE V16.B16, s2.B16; \
	AESMC s2.B16, s2.B16; \
	/* Branch 3: s7 ^= F0(s6), s6 = F3(s6, RC1) */ \
	VORR s6.B16, s6.B16, V8.B16; \
	AESE V16.B16, V8.B16; \
	AESMC V8.B16, V8.B16; \
	VEOR s7.B16, V8.B16, s7.B16; \
	MOVD $off1, R2; \
	ADD R2, R1, R2; \
	VLD1 (R2), [V9.B16]; \
	AESE V16.B16, s6.B16; \
	VEOR V9.B16, s6.B16, s6.B16; \
	AESE V16.B16, s6.B16; \
	AESMC s6.B16, s6.B16;

	ROUND1K(V0, V1, V2, V3, V4, V5, V6, V7, 0, 16)
	ROUND1K(V1, V2, V3, V4, V5, V6, V7, V0, 32, 48)
	ROUND1K(V2, V3, V4, V5, V6, V7, V0, V1, 64, 80)
	ROUND1K(V3, V4, V5, V6, V7, V0, V1, V2, 96, 112)
	ROUND1K(V4, V5, V6, V7, V0, V1, V2, V3, 128, 144)
	ROUND1K(V5, V6, V7, V0, V1, V2, V3, V4, 160, 176)
	ROUND1K(V6, V7, V0, V1, V2, V3, V4, V5, 192, 208)
	ROUND1K(V7, V0, V1, V2, V3, V4, V5, V6, 224, 240)
	ROUND1K(V0, V1, V2, V3, V4, V5, V6, V7, 256, 272)
	ROUND1K(V1, V2, V3, V4, V5, V6, V7, V0, 288, 304)
	ROUND1K(V2, V3, V4, V5, V6, V7, V0, V1, 320, 336)
	ROUND1K(V3, V4, V5, V6, V7, V0, V1, V2, 352, 368)
	ROUND1K(V4, V5, V6, V7, V0, V1, V2, V3, 384, 400)
	ROUND1K(V5, V6, V7, V0, V1, V2, V3, V4, 416, 432)
	ROUND1K(V6, V7, V0, V1, V2, V3, V4, V5, 448, 464)
	ROUND1K(V7, V0, V1, V2, V3, V4, V5, V6, 480, 496)
	ROUND1K(V0, V1, V2, V3, V4, V5, V6, V7, 512, 528)
	ROUND1K(V1, V2, V3, V4, V5, V6, V7, V0, 544, 560)
	ROUND1K(V2, V3, V4, V5, V6, V7, V0, V1, 576, 592)
	ROUND1K(V3, V4, V5, V6, V7, V0, V1, V2, 608, 624)
