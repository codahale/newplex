...
// Uses V20, V21, V22, V23 for intermediate states and V24, V25, V26, V27 for constants.
#define ROUND_8_STEP(s0, s1, s2, s3, s4, s5, t0, t1) \
    VLD1 (R10), [V24.B16, V25.B16, V26.B16, V27.B16]; ADD $64, R10; \
    VORR s0.B16, s0.B16, V20.B16; VORR t0.B16, t0.B16, V21.B16; \
    VORR s4.B16, s4.B16, V22.B16; VORR s2.B16, s2.B16, V23.B16; \
    AESE V16.B16, V20.B16; AESMC V20.B16, V20.B16; \
    AESE V16.B16, V21.B16; AESMC V21.B16, V21.B16; \
    AESE V16.B16, V22.B16; AESMC V22.B16, V22.B16; \
    AESE V16.B16, V23.B16; AESMC V23.B16, V23.B16; \
    AESE V24.B16, V20.B16; AESMC V20.B16, V20.B16; \
    AESE V25.B16, V21.B16; AESMC V21.B16, V21.B16; \
    AESE V26.B16, V22.B16; AESMC V22.B16, V22.B16; \
    AESE V27.B16, V23.B16; AESMC V23.B16, V23.B16; \
    VEOR V20.B16, s1.B16, s1.B16; VEOR V21.B16, s5.B16, s5.B16; \
    VEOR V22.B16, s3.B16, s3.B16; VEOR V23.B16, t1.B16, t1.B16
